//
//  SWReferenceSelectionListView.swift
//  Main
//
...
struct SWReferenceSelectionChipContent {
    let title: String
}

final class SWReferenceSelectionListView: UIView {
    ...
    func configure(items: [SWReferenceSelectionChipContent]) {
