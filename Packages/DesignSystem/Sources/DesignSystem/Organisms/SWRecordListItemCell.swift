...
public struct SWRecordListItemContent {
    public let iconImage: UIImage?
    public let audioURL: URL

    public init(iconImage: UIImage?, audioURL: URL) {
        self.iconImage = iconImage
        self.audioURL = audioURL
    }
}

public final class SWRecordListItemCell: UITableViewCell {
    public static let identifier = "SWRecordListItemCell"
    public static let height = SWSize.recordRowHeight
    ...
    public func configure(with content: SWRecordListItemContent) {
