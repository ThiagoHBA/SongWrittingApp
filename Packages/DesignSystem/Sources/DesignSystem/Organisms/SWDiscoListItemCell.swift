...
public struct SWDiscoListItemContent {
    public let title: String
    public let description: String?
    public let coverImage: UIImage?
    public let referenceCoverURLs: [URL]

    public init(title: String, description: String? = nil, coverImage: UIImage?, referenceCoverURLs: [URL] = []) {
        self.title = title
...
public final class SWDiscoListItemCell: UITableViewCell {
    public static let identifier = "SWDiscoListItemCell"
    ...
    public func configure(with content: SWDiscoListItemContent) {
